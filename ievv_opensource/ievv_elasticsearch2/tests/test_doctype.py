...
class TestDocType(test.TestCase):
    ...
    def test_base_class_is_abstract(self):
        self.assertTrue(ievv_elasticsearch2.DocType.abstract)

    def test_subclass_is_not_abstract(self):
        class MyDocType(ievv_elasticsearch2.DocType):
            pass

        self.assertFalse(MyDocType.abstract)

    def test_subclass_can_be_abstract(self):
        class MyDocType(ievv_elasticsearch2.DocType):
            abstract = True

        self.assertTrue(MyDocType.abstract)
...
class TestModelDocType(test.TestCase):
    ...
    def test_base_class_is_abstract(self):
        self.assertTrue(ievv_elasticsearch2.ModelDocType.abstract)
